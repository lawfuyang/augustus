...
typedef enum {
    ...
    TR_SIDEBAR_EXTRA_HOUSING_AVAILABLE,
    TR_SIDEBAR_EXTRA_POPULATION_GOAL_MET,
    TR_SIDEBAR_EXTRA_POPULATION_GOAL_NOT_MET,
    TR_SIDEBAR_EXTRA_ROOM_FOR_NEEDED_EMPLOYEES,
    TR_SIDEBAR_EXTRA_NOT_ENOUGH_ROOM_FOR_NEEDED_EMPLOYEES,
    TRANSLATION_MAX_KEY
} translation_key;
