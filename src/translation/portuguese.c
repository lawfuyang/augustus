...
static translation_string all_strings[] = {
   {TR_NO_PATCH_TITLE, "Atualização 1.0.1.0 não instalada"},
    ...
    {TR_CONFIG_ARE_YOU_SURE, "Redefinir os padrões?"},
    ...
    {TR_CONFIG_HEADER_WATER_STRUCTURE_RANGE, "Mostrar alcance de fontes e poços"},
    ...
    {TR_CONFIG_GODS_EFFECTS, "Ativar bênçãos/pragas dos deuses"},
    ...
    {TR_CONFIG_NOT_ACCEPTING_WAREHOUSES, "Armazéns e celeiros não aceitam nada quando são construídos"},
    {TR_CONFIG_HOUSES_DONT_EXPAND_INTO_GARDENS, "Moradias não se expandem sobre jardins"},
    {TR_CONFIG_GP_CH_AUTO_CLEAR_TREES, "Remover árvores e arbustos automaticamente ao posicionar edifícios"},
    ...
    { TR_BUILDING_GRAND_TEMPLE_NEPTUNE_BONUS_DESC, "Netuno concede +1 de alcance a fontes e poços e +2 a reservatórios. A necessidade de trabalhadores dos serviços de água também é reduzida em 50%, e os navios mercantes viajam 25% mais rápido. A incidência de doenças nas moradias é bastante reduzida." },
    { TR_BUILDING_GRAND_TEMPLE_MERCURY_BONUS_DESC, "Mercúrio abençoa as caravanas e os navios mercantes com 50% a mais de capacidade e faz com que as caravanas se movam 25% mais rápido." },
    { TR_BUILDING_GRAND_TEMPLE_MARS_BONUS_DESC, "Marte conclama seus cidadãos a se alistarem, enviando recrutas aos fortes da cidade e permitindo a construção de quatro fortes adicionais." },
    { TR_BUILDING_GRAND_TEMPLE_VENUS_BONUS_DESC, "Vênus agracia os jardins, estátuas e templos da cidade, fazendo-os reluzir e aumentando sua atratividade. As moradias também armazenam mais bens e regridem mais lentamente." },
    { TR_BUILDING_PANTHEON_BONUS_DESC, "O Panteão permite que os cidadãos venerem todos os deuses. Festivais anuais também são realizados aqui, e os custos de manutenção dos edifícios religiosos e culturais são reduzidos em 25%." },
    ...
    { TR_BUILDING_LIGHTHOUSE_PHASE_1_TEXT, "Os pedreiros estão assentando uma fundação sólida para sustentar o peso de uma grande torre de pedra." },
    { TR_BUILDING_LIGHTHOUSE_PHASE_2_TEXT, "Os pedreiros estão construindo um pedestal para elevar a chama do farol além do horizonte." },
    ...
    {TR_CITY_MESSAGE_TEXT_LIGHTHOUSE_COMPLETE, "A imponente torre de pedra do farol, já completa, assoma no horizonte. Que a sua chama guie os navios de volta para casa até o fim dos tempos." },
    ...
    {TR_WARNING_OPEN_WATER_NEEDED_FOR_BUILDING, "O edifício deve ser construído próximo a águas abertas"},
    ...
    {TR_BUILDING_WINDOW_HOUSE_SENTIMENT_1, "Os residentes abominam a mera menção de teu nome."},
    ...
    {TR_BUILDING_LARGE_TEMPLE_PHASE_1_TEXT, "Os pedreiros constroem as paredes e colunas da 'cella', o recinto interno deste templo que abrigará a imagem sagrada." },
    ...
    {TR_CITY_MESSAGE_TEXT_OLYMPIC_GAMES_ENDING, "A chama sagrada se apaga, e viajantes e cidadãos voltam aos poucos para casa, exaustos e exultantes. A glória eterna é sua por ter sediado com sucesso esta antiga e sagrada celebração da força e da honra humanas." },
    ...
    {TR_TOOLTIP_BUTTON_ROADBLOCK_PERMISSION_MARKET, "Alterar acesso de compradoras do mercado" },
    {TR_TOOLTIP_BUTTON_ROADBLOCK_PERMISSION_ENTERTAINER, "Alterar acesso de artistas" },
    {TR_TOOLTIP_BUTTON_ROADBLOCK_PERMISSION_EDUCATION, "Alterar acesso de professores e estudantes" },
    {TR_TOOLTIP_BUTTON_ROADBLOCK_PERMISSION_MEDICINE, "Alterar acesso de profissionais de saúde" },
    {TR_TOOLTIP_BUTTON_ROADBLOCK_PERMISSION_TAX_COLLECTOR, "Alterar acesso de cobradores de impostos" },
    {TR_TOOLTIP_BUTTON_ROADBLOCK_PERMISSION_LABOR_SEEKER, "Alterar acesso de recrutadores de trabalhadores" },
    {TR_TOOLTIP_BUTTON_ROADBLOCK_PERMISSION_MISSIONARY, "Alterar acesso de missionários" },
    {TR_TOOLTIP_BUTTON_ROADBLOCK_PERMISSION_WATCHMAN, "Alterar acesso de sentinelas" },
    ...
    {TR_BUILDING_HIGHWAY_STATION, "Posto de Estradas Imperiais"},
    {TR_BUILDING_HIGHWAY_STATION_DESC, "O posto de Estradas Imperiais abriga trabalhadores qualificados que constroem e mantêm a rede de Estradas Imperiais. Um fornecimento constante de pedra e areia, enviado por um campo de trabalho, reduzirá pela metade o custo de novas Estradas Imperiais e a manutenção mensal de todas elas."},
    {TR_BUILDING_HIGHWAY_STATION_NO_EMPLOYEES, "Este posto de Estradas Imperiais não tem funcionários. A manutenção das Estradas Imperiais está suspensa."},
    {TR_BUILDING_HIGHWAY_STATION_NO_RESOURCES, "Este posto de Estradas Imperiais precisa de mais pedra e areia para manter a rede de Estradas Imperiais."},
    {TR_BUILDING_HIGHWAY_STATION_FUNCTIONAL, "O posto de Estradas Imperiais está funcionando. Os custos de construção e manutenção das Estradas Imperiais foram reduzidos pela metade."},
    {TR_BUILDING_HIGHWAY_STATION_NOT_FUNCTIONAL, "O posto de Estradas Imperiais está ocioso. Os custos de construção e manutenção das Estradas Imperiais estão no valor integral."},
    {TR_BUILDING_HIGHWAY_STATION_MONTHLY_NEED, "Consumo mensal (de cada):"},
    {TR_BUILDING_HIGHWAY_STATION_HIGHWAY_TILES, "Estradas Imperiais na cidade:"},
    {TR_BUILDING_HIGHWAY_STATION_STONE_STOCK, "Pedra armazenada,"},
    {TR_BUILDING_HIGHWAY_STATION_SAND_STOCK, "Areia armazenada,"},
    {TR_TOOLTIP_BUTTON_HIGHWAY_STATION, "Posto de Estradas Imperiais"},
    {TR_WARNING_HIGHWAY_STATION_NEEDS_SENATE, "Primeiro, construa um campo de trabalho."},
    ...
    {TR_BUILDING_HOUSE_DISEASE_DESC, "A peste se abateu sobre nós! Sem serviços de saúde adequados, os moradores deste local morreram doentes. Esta moradia ficará em quarentena até que um médico ou cirurgião descontamine o local." },
    ...
    {TR_CONFIG_UI_CLIMATE_GRID_COLORS, "Mostrar cores correspondentes ao clima na grade completa"},
    ...
    {TR_EDITOR_EMPIRE_TOOL, "Ferramenta atual do império: "},
    ...
    {TR_CITY_WARNING_WORKCAMP_NEEDED, "Este edifício precisa de um campo de trabalho em funcionamento"},
    {TR_CITY_WARNING_BUILD_WORKCAMP, "Construa um campo de trabalho"},
    ...
    {TR_CITY_MESSAGE_TEXT_TRADE_ROUTE_PRICE_CHANGE, "O preço para abrir uma rota comercial mudou." },
    ...
    {TR_PARAMETER_VALUE_MESSAGE_CITY_STILL_IN_DEBT, "Cidade ainda endividada"},
    ...
    {TR_BUILDING_LATRINES_MISSING_EVOLVE, "Esta casa não pode evoluir, já que não tem acesso a uma latrina ou à água limpa de uma fonte."},
    ...
    {TR_EDITOR_EARTHQUAKE_CUSTOM, "Personalizado"},
    {TR_EDITOR_TOOL_EARTHQUAKE_POINT, "Ponto do terremoto"},
    {TR_EDITOR_TOOL_EARTHQUAKE_CUSTOM, "Terremoto personalizado"},
    {TR_EDITOR_TOOL_EARTHQUAKE_REMOVE, "Remover terremoto"},
    {TR_ACTION_TYPE_CHANGE_MODEL_DATA, "Alterar dados do modelo"},
    {TR_PARAMETER_MODEL, "Modelo"},
    {TR_PARAMETER_DATA_TYPE, "Tipo de dado"},
    {TR_PARAMETER_COST, "Custo"},
    {TR_PARAMETER_DESIRABILITY_VALUE, "Valor de atratividade"},
    {TR_PARAMETER_DESIRABILITY_STEP, "Intervalo da atratividade"},
    {TR_PARAMETER_DESIRABILITY_STEP_SIZE, "Variação por intervalo"},
    {TR_PARAMETER_DESIRABILITY_RANGE, "Alcance da atratividade"},
    {TR_PARAMETER_LABORERS, "Trabalhadores"},
    {TR_PARAMETER_SET, "Definir"},
    {TR_PARAMETER_CHANGE, "Alterar"},
    {TR_PARAMETER_OF, "de"},
    {TR_PARAMETER_TO, "para"},
    {TR_PARAMETER_BY, "por"},
    ...
    {TR_EDITOR_PARAMETER_CITY_PROPERTY, "Propriedade da cidade"},
    {TR_EDITOR_ACTION_TYPE_CITY_PROPERTY, "Alterar valor de variável personalizada (propriedade da cidade)"},
    {TR_PARAMETER_PERCENTAGE, "Porcentagem"},
    {TR_PARAMETER_ABSOLUTE, "Absoluto"},
    {TR_DECENNIUM_0, "0-9"},
    ...
    {TR_CITY_PROPERTY_NONE, "Nenhuma"},
    {TR_CITY_PROPERTY_DIFFICULTY, "Dificuldade"},
    {TR_CITY_PROPERTY_MONEY, "Dinheiro da cidade"},
    {TR_CITY_PROPERTY_POPULATION, "População"},
    {TR_CITY_PROPERTY_SAVINGS, "Economias pessoais"},
    {TR_CITY_PROPERTY_YEAR_FINANCE_BALANCE, "Saldo financeiro anual"},
    {TR_CITY_PROPERTY_RESOURCE_STOCK, "Estoque de recursos"},
    {TR_CITY_PROPERTY_STATS_FAVOR, "Apreço"},
    {TR_CITY_PROPERTY_STATS_PROSPERITY, "Prosperidade"},
    {TR_CITY_PROPERTY_STATS_CULTURE, "Cultura"},
    {TR_CITY_PROPERTY_STATS_PEACE, "Paz"},
    {TR_CITY_PROPERTY_STATS_CITY_HEALTH, "Saúde da cidade"},
    {TR_CITY_PROPERTY_SERVICE_COVERAGE, "Cobertura de serviços"},
    {TR_CITY_PROPERTY_POPS_UNEMPLOYMENT, "Desemprego"},
    {TR_CITY_PROPERTY_POPS_HOUSING_TYPE, "População por nível de moradia"},
    {TR_CITY_PROPERTY_POPS_BY_AGE, "População por idade"},
    {TR_CITY_PROPERTY_ROME_WAGES, "Salários de Roma"},
    {TR_CITY_PROPERTY_CITY_WAGES, "Salários da cidade"},
    {TR_CITY_PROPERTY_BUILDING_COUNT, "Quantidade de edifícios"},
    {TR_CITY_PROPERTY_TROOPS_COUNT_PLAYER, "Tropas do jogador"},
    {TR_CITY_PROPERTY_TROOPS_COUNT_ENEMY, "Tropas inimigas"},
    {TR_CITY_PROPERTY_TERRAIN_COUNT_TILES, "Quadrados de terreno"},
    {TR_CITY_PROPERTY_TROOPS_MELEE, "Tropas de combate corpo a corpo"},
    {TR_CITY_PROPERTY_TROOPS_RANGED, "Tropas de combate à distância"},
    {TR_CITY_PROPERTY_TROOPS_MOUNTED, "Tropas montadas"},
    {TR_CITY_PROPERTY_ALL, "Todos"},
    {TR_CITY_PROPERTY_ACTIVE_ONLY, "Somente ativos"},
    {TR_CITY_PROPERTY_COVERAGE_THEATRE, "Cobertura de teatros"},
    {TR_CITY_PROPERTY_COVERAGE_ARENA, "Cobertura de arenas"},
    {TR_CITY_PROPERTY_COVERAGE_AMPHITHEATRE, "Cobertura de anfiteatros"},
    {TR_CITY_PROPERTY_COVERAGE_TAVERN, "Cobertura de tabernas"},
    {TR_CITY_PROPERTY_COVERAGE_COLOSSEUM, "Cobertura do Coliseu"},
    {TR_CITY_PROPERTY_COVERAGE_HIPPODROME, "Cobertura do hipódromo"},
    {TR_CITY_PROPERTY_COVERAGE_BATHS, "Cobertura de balneários"},
    {TR_CITY_PROPERTY_COVERAGE_DOCTOR, "Cobertura de médicos"},
    {TR_CITY_PROPERTY_COVERAGE_BARBER, "Cobertura de barbeiros"},
    {TR_CITY_PROPERTY_COVERAGE_HOSPITAL, "Cobertura de hospitais"},
    {TR_CITY_PROPERTY_COVERAGE_SCHOOL, "Cobertura de escolas"},
    {TR_CITY_PROPERTY_COVERAGE_LIBRARY, "Cobertura de bibliotecas"},
    {TR_CITY_PROPERTY_COVERAGE_ACADEMY, "Cobertura de academias"},
    {TR_CITY_PROPERTY_CHOOSE_PROPERTY, "Escolha a propriedade da cidade"},
    {TR_BUTTON_INFO_RETURN_ALL_LEGIONS, "Chamar todas as legiões de volta"},
    {TR_WARNING_DEPOT_RECALL_ALL, "Todos os carroceiros das guildas foram chamados de volta!"},
    {TR_WARNING_DEPOT_RESOURCE_CHANGE, "Não é possível alterar o recurso enquanto houver carroceiros ativos!"},
    {TR_WINDOW_BUILDING_DEPOT_CART_PUSHER_WAIT_LOAD, "Nossa carroça está esperando para ser carregada."},
    {TR_WINDOW_BUILDING_DEPOT_CART_PUSHER_WAIT_UNLOAD, "Nossa carroça está esperando para ser descarregada."},
    {TR_WINDOW_BUILDING_DEPOT_CART_PUSHER_GETTING_FOOD, "Nossa carroça está indo ao celeiro buscar comida."},
    {TR_WINDOW_BUILDING_DEPOT_CART_PUSHER_GETTING_GOODS, "Nossa carroça está indo ao armazém buscar mercadorias."},
    {TR_WINDOW_BUILDING_DEPOT_CART_PUSHER_DELIVER, "Nossa carroça está entregando mercadorias."},
    {TR_WINDOW_BUILDING_DEPOT_CART_PUSHER_WAIT, "Nossa carroça está aguardando novas instruções."},
    {TR_TOOLTIP_DEPOT_CLEAR_SRC, "Limpar origem"},
    {TR_TOOLTIP_DEPOT_CLEAR_DST, "Limpar destino"},
    {TR_CITY_PROPERTY_QUOTA_FILL, "Preenchimento da cota"},
    {TR_EDITOR_BUYS, "(Compra)"},
    {TR_EDITOR_SELLS, "(Venda)"},
    {TR_EDITOR_ALL_BUYS, "Todas (Compra)"},
    {TR_EDITOR_ALL_SELLS, "Todas (Venda)"},
    {TR_ACTION_TYPE_WIN, "Vitória imediata"},
    {TR_ACTION_TYPE_LOSE, "Derrota imediata"},
    {TR_ACTION_TYPE_GOD_SENTIMENT, "Alterar disposição do deus"},
    {TR_ACTION_TYPE_POP_SENTIMENT, "Alterar satisfação da população"},
    {TR_MESSAGE_PROMOTE_RANK_PREFIX, "Excelentes notícias, Governador! Em reconhecimento a seu desempenho, Caesar o promoveu ao posto de "},
    {TR_MESSAGE_DEMOTE_RANK_PREFIX, "Notícias graves, Governador! Insatisfeito com seu desempenho, Caesar o rebaixou ao posto de "},
    {TR_MESSAGE_PROMOTE_RANK_SUFFIX, ". O novo posto traz um aumento de salário. Parabéns!"},
    {TR_MESSAGE_DEMOTE_RANK_SUFFIX, ". Seu salário foi reduzido!"},
    {TR_PARAMETER_TYPE_RANK, "Posto do Governador"},
    {TR_RANK_PROMOTE, "Promover (+1 posto)"},
    {TR_RANK_DEMOTE, "Rebaixar (-1 posto)"},
    {TR_RANK_CITIZEN, "Cidadão"},
    {TR_RANK_CLERK, "Funcionário"},
    {TR_RANK_ENGINEER, "Engenheiro"},
    {TR_RANK_ARCHITECT, "Arquiteto"},
    {TR_RANK_QUAESTOR, "Questor"},
    {TR_RANK_PROCURATOR, "Procurador"},
    {TR_RANK_AEDILE, "Edil"},
    {TR_RANK_PRAETOR, "Pretor"},
    {TR_RANK_CONSUL, "Cônsul"},
    {TR_RANK_PROCONSUL, "Procônsul"},
    {TR_RANK_CAESAR, "Caesar"},
    {TR_ACTION_TYPE_CHANGE_RANK, "Alterar posto do Governador"},
    {TR_CITY_MESSAGE_TITLE_GOVERNOR_RANK_CHANGE, "Posto do Governador"},
    ...
    {TR_EDITOR_RESET_FAVOR_MONTHLY, "Redefinir apreço mensalmente"},
    {TR_CONFIG_UI_WT_ENABLE_SNOW_CENTRAL, "Habilitar neve no clima central"},
    {TR_EDITOR_UNABLE_TO_LOAD_MODEL_DATA_TITLE, "Não foi possível carregar o XML de dados do modelo"},
    {TR_EDITOR_MODEL_DATA_IMPORT_FULL, "Importar dados do modelo"},
    {TR_EDITOR_MODEL_DATA_EXPORT_FULL, "Exportar dados do modelo"},
    {TR_EDITOR_COLOR_LABEL, "Cor"},
    {TR_EDITOR_COLOR_NONE, "Nenhuma"},
    {TR_EDITOR_COLOR_BLUE, "Azul"},
    {TR_EDITOR_COLOR_ORANGE, "Laranja"},
    {TR_EDITOR_COLOR_GREEN, "Verde"},
    {TR_EDITOR_COLOR_PURPLE, "Roxo"},
    {TR_EDITOR_COLOR_OLIVE, "Oliva"},
    {TR_EDITOR_COLOR_TURQUOISE, "Turquesa"},
    {TR_EDITOR_COLOR_CORAL, "Vermelho"},
    {TR_EDITOR_COLOR_GRAY, "Cinza"},
    {TR_EDITOR_COLOR_BLACK, "Preto"},
    {TR_EDITOR_COLOR_DARK_BLUE, "Azul-escuro"},
    {TR_EDITOR_RUBBLE, "Escombros"},
    {TR_EDITOR_TOOL_WATER, "Água"},
    {TR_EDITOR_TOOL_SHALLOW, "Águas rasas"},
    {TR_PARAMETER_GRID_OFFSET_CORNER1, "Canto 1"},
    {TR_PARAMETER_GRID_OFFSET_CORNER2, "Canto 2"},
    {TR_CONDITION_TYPE_TERRAIN_IN_AREA, "Terreno na área"},
    {TR_CONFIG_UI_CV_CURSOR_SHADOW, "Habilitar sombra do cursor"},
    {TR_EDITOR_MODEL_PRODUCTION, "Taxa"},
    {TR_ACTION_TYPE_PRODUCTION_RATE, "Alterar taxa de produção"},
    {TR_EDITOR_EARTHQUAKE_RIGHT_TO_LEFT, "Da direita para a esquerda"},
    {TR_EDITOR_EARTHQUAKE_RANDOM, "Aleatório"},
    {TR_EDITOR_EARTHQUAKE_RANDOM_RIGHT_TO_LEFT, "Aleatório da direita para a esquerda"},
    {TR_EDITOR_DESIRABILITY_VALUE, "Valor de atratividade\nO valor inicial do edifício"},
    {TR_EDITOR_DESIRABILITY_STEP, "Intervalo da atratividade\nA quantidade de quadrados até o próximo aumento ou redução do valor"},
    {TR_EDITOR_DESIRABILITY_STEP_SIZE, "Variação por intervalo\nO quanto o valor aumenta ou diminui"},
    {TR_EDITOR_DESIRABILITY_RANGE, "Alcance da atratividade\nO alcance máximo além do qual não há impacto"},

    {TR_EDITOR_EARTHQUAKE_PATTERN, "Padrão"},
    ...
    {TR_EDITOR_EARTHQUAKE_CUSTOM_SET, "Terremoto personalizado"},
    {TR_BUILDING_HOUSE_SMALL_TENT, "Cabana Pequena"},
    {TR_BUILDING_HOUSE_LARGE_TENT, "Cabana Grande"},
    {TR_BUILDING_HOUSE_SMALL_SHACK, "Choupana Pequena"},
    {TR_BUILDING_HOUSE_LARGE_SHACK, "Choupana Grande"},
    {TR_BUILDING_HOUSE_SMALL_HOVEL, "Casebre Pequeno"},
    {TR_BUILDING_HOUSE_LARGE_HOVEL, "Casebre Grande"},
    {TR_BUILDING_HOUSE_SMALL_CASA, "Casa Pequena"},
    {TR_BUILDING_HOUSE_LARGE_CASA, "Casa Grande"},
    {TR_BUILDING_HOUSE_SMALL_INSULA, "Insula Pequena"},
    {TR_BUILDING_HOUSE_MEDIUM_INSULA, "Insula Média"},
    {TR_BUILDING_HOUSE_LARGE_INSULA, "Insula Grande"},
    {TR_BUILDING_HOUSE_GRAND_INSULA, "Insula Suntuosa"},
    {TR_BUILDING_HOUSE_SMALL_VILLA, "Villa Pequena"},
    {TR_BUILDING_HOUSE_MEDIUM_VILLA, "Villa Média"},
    {TR_BUILDING_HOUSE_LARGE_VILLA, "Villa Grande"},
    {TR_BUILDING_HOUSE_GRAND_VILLA, "Villa Suntuosa"},
    {TR_BUILDING_HOUSE_SMALL_PALACE, "Palácio Pequeno"},
    {TR_BUILDING_HOUSE_MEDIUM_PALACE, "Palácio Médio"},
    {TR_BUILDING_HOUSE_LARGE_PALACE, "Palácio Grande"},
    {TR_BUILDING_HOUSE_LUXURY_PALACE, "Palácio Luxuoso"},
    {TR_ACTION_TYPE_CHANGE_HOUSE_MODEL_DATA, "Alterar dados do modelo de moradia"},
    {TR_PARAMETER_DEVOLVE_DESIRABILITY, "Atratividade para regredir"},
    {TR_PARAMETER_EVOLVE_DESIRABILITY, "Atratividade para evoluir"},
    {TR_PARAMETER_ENTERTAINMENT, "Entretenimento"},
    {TR_PARAMETER_WATER, "Água"},
    {TR_PARAMETER_RELIGION, "Religião"},
    {TR_PARAMETER_EDUCATION, "Educação"},
    {TR_PARAMETER_BARBER, "Barbeiro"},
    {TR_PARAMETER_BATHHOUSE, "Balneário"},
    {TR_PARAMETER_HEALTH, "Saúde"},
    {TR_PARAMETER_FOOD_TYPES, "Tipos de comida"},
    {TR_PARAMETER_POTTERY, "Cerâmica"},
    {TR_PARAMETER_FURNITURE, "Móveis"},
    {TR_PARAMETER_OIL, "Azeite"},
    {TR_PARAMETER_WINE, "Vinho"},
    {TR_PARAMETER_PROSPERITY, "Prosperidade"},
    {TR_PARAMETER_MAX_PEOPLE, "Máximo de pessoas"},
    {TR_PARAMETER_TAX_MULTIPLIER, "Multiplicador de impostos"},
    {TR_PARAMETER_TYPE_HOUSING_TYPE, "Nível da moradia"},
    {TR_PARAMETER_BUILDING_MODEL_REST_CONFIRMATION, "Isto redefine somente os dados do modelo do edifício."},
    {TR_CHEAT_DESTROYED_BUILDING, "Edifício destruído"},
    {TR_PARAMETER_HOUSE_MODEL_REST_CONFIRMATION, "Isto redefine somente os dados do modelo da moradia."},
    ...
    {TR_EDITOR_HOUSE_MODEL_EXPLANATION_DEVOLVE_DESIRABILITY, "Atratividade para regredir\nO valor de atratividade abaixo do qual a moradia regride"},
    {TR_EDITOR_HOUSE_MODEL_EXPLANATION_EVOLVE_DESIRABILITY, "Atratividade para evoluir\nO valor de atratividade acima do qual a moradia evolui"},
    {TR_EDITOR_HOUSE_MODEL_EXPLANATION_ENTERTAINMENT, "Entretenimento\nO valor de entretenimento necessário\nPor exemplo, 10 é o valor fornecido por um teatro"},
    {TR_EDITOR_HOUSE_MODEL_EXPLANATION_WATER, "Água\nO nível de água necessário para a moradia\n0: Nenhuma, 1 = Poço, 2 = Poço + Latrina, 3 = Fonte"},
    {TR_EDITOR_HOUSE_MODEL_EXPLANATION_RELIGION, "Religião\nQuantidade de deuses necessária para a moradia"},
    {TR_EDITOR_HOUSE_MODEL_EXPLANATION_EDUCATION, "Educação\nInstalações educacionais necessárias\n0: Nenhuma, 1 = Escola ou Biblioteca, 2 = Escola e Biblioteca, 3 = Escola, Biblioteca e Academia"},
    {TR_EDITOR_HOUSE_MODEL_EXPLANATION_BARBER, "Barbeiro\nIndica se a moradia precisa de barbeiro: 0 ou 1"},
    {TR_EDITOR_HOUSE_MODEL_EXPLANATION_BATHHOUSE, "Balneário\nIndica se a moradia precisa de acesso a um balneário: 0 ou 1"},
    {TR_EDITOR_HOUSE_MODEL_EXPLANATION_HEALTH, "Saúde\nServiços de saúde necessários\n1 = médico ou hospital, 2 = médico e hospital"},
    {TR_EDITOR_HOUSE_MODEL_EXPLANATION_FOOD_TYPES, "Tipos de comida\nQuantidade de tipos diferentes de comida necessários"},
    {TR_EDITOR_HOUSE_MODEL_EXPLANATION_POTTERY, "Cerâmica\nIndica se a moradia precisa de cerâmica: 0 ou 1"},
    {TR_EDITOR_HOUSE_MODEL_EXPLANATION_FURNITURE, "Móveis\nIndica se a moradia precisa de móveis: 0 ou 1"},
    {TR_EDITOR_HOUSE_MODEL_EXPLANATION_OIL, "Azeite\nIndica se a moradia precisa de azeite: 0 ou 1"},
    {TR_EDITOR_HOUSE_MODEL_EXPLANATION_WINE, "Vinho\nQuantidade de tipos de vinho necessários"},
    {TR_EDITOR_HOUSE_MODEL_EXPLANATION_PROSPERITY, "Prosperidade\nO valor que a moradia acrescenta ao limite de atratividade"},
    {TR_EDITOR_HOUSE_MODEL_EXPLANATION_MAX_PEOPLE, "Máximo de pessoas\nQuantidade de pessoas que pode morar neste nível de moradia"},
    {TR_EDITOR_HOUSE_MODEL_EXPLANATION_TAX_MULTIPLIER, "Multiplicador de impostos\nUm multiplicador aplicado aos impostos"},
    {TR_CONFIG_UI_BUILD_SHOW_RESERVOIR_RANGES, "Mostrar o alcance de reservatórios ao construir outros reservatórios e edifícios que dependem de sua cobertura"},
    {TR_CONFIG_GP_CH_ALWAYS_DESTROY_BRIDGES, "Sempre permitir a remoção de pontes"},
    {TR_CONFIG_CATEGORY_MANAGEMENT_DESTRUCTION, "Demolição"},
    {TR_EMPIRE_TOOL_OUR_CITY, "Nossa cidade"},
    {TR_EMPIRE_TOOL_TRADE_CITY, "Cidade comercial"},
    {TR_EMPIRE_TOOL_ROMAN_CITY, "Cidade romana"},
    {TR_EMPIRE_TOOL_VULNERABLE_CITY, "Cidade vulnerável"},
    {TR_EMPIRE_TOOL_FUTURE_TRADE_CITY, "Futura cidade comercial"},
    {TR_EMPIRE_TOOL_DISTANT_CITY, "Cidade distante"},
    {TR_EMPIRE_TOOL_BORDER, "Segmento da fronteira"},
    {TR_EMPIRE_TOOL_BATTLE, "Batalha"},
    {TR_EMPIRE_TOOL_DISTANT_BABARIAN, "Exército inimigo distante"},
    {TR_EMPIRE_TOOL_DISTANT_LEGION, "Legião romana distante"},
    {TR_EMPIRE_TOOL_SELECT, "Ferramenta de seleção"},
    {TR_HOTKEY_EDITOR_EMPIRE_DELETE_OBJECT, "Excluir objeto do império"},
    {TR_PARAMETER_BUYING, "Ajustar compras"},
    {TR_EDITOR_DEMAND_CHANGE_BUYS, "compra"},
    {TR_EDITOR_DEMAND_CHANGE_SELLS, "venda"},
    {TR_EDITOR_VIEW_CURRENT_EMPIRE, "Ver império atual"},
    {TR_EDITOR_CREATE_NEW_EMPIRE, "Criar novo império"},
    {TR_CONFIG_UI_EMPIRE_SMART_BORDER_PLACEMENT, "Ativar posicionamento inteligente da fronteira"},
    {TR_CONFIG_CATEGORY_UI_EMPIRE, "Império"},
    {TR_EDITOR_CUSTOM_EMPIRE_TITLE_SAVE, "Salvando um império"},
    {TR_EDITOR_EMPIRE_EXPORT, "Exportar império"},
    {TR_EDITOR_EMPIRE_IMPORT, "Importar império"},
    {TR_CONFIG_ENABLE_BUILD_MENU_SHORTCUTS, "Ativar atalhos do menu de construções"},
    {TR_EDITOR_CURRENT_ICON, "Ícone atual da cidade:"},
    {TR_EMPIRE_CITY_ICON_DEFAULT, "Sem ícone"},
    {TR_EMPIRE_CITY_ICON_CONSTRUCTION, "Construção"},
    {TR_EMPIRE_CITY_ICON_DISTANT_TOWN, "Cidade pequena distante"},
    {TR_EMPIRE_CITY_ICON_DISTANT_VILLAGE, "Aldeia distante"},
    {TR_EMPIRE_CITY_ICON_RESOURCE_FOOD, "Recurso alimentar"},
    {TR_EMPIRE_CITY_ICON_RESOURCE_GOODS, "Recurso comercial"},
    {TR_EMPIRE_CITY_ICON_RESOURCE_SEA, "Recurso marítimo"},
    {TR_EMPIRE_CITY_ICON_TRADE_TOWN, "Cidade pequena comercial"},
    {TR_EMPIRE_CITY_ICON_ROMAN_TOWN, "Cidade pequena romana"},
    {TR_EMPIRE_CITY_ICON_TRADE_VILLAGE, "Aldeia comercial"},
    {TR_EMPIRE_CITY_ICON_ROMAN_VILLAGE, "Aldeia romana"},
    {TR_EMPIRE_CITY_ICON_ROMAN_CAPITAL, "Capital"},
    {TR_EMPIRE_CITY_ICON_TRADE_SEA, "Comércio marítimo"},
    {TR_EMPIRE_CITY_ICON_TRADE_LAND, "Comércio terrestre"},
    {TR_EMPIRE_CITY_ICON_OUR_CITY, "Nossa cidade"},
    {TR_EMPIRE_CITY_ICON_TRADE_CITY, "Cidade comercial"},
    {TR_EMPIRE_CITY_ICON_ROMAN_CITY, "Cidade romana"},
    {TR_EMPIRE_CITY_ICON_DISTANT_CITY, "Cidade distante"},
    {TR_EMPIRE_CITY_ICON_TOWER, "Torre"},
    {TR_ACTION_TYPE_LOCK_TRADE_ROUTE, "Bloquear rota comercial"},
    {TR_PARAMETER_LOCK, "Bloquear"},
    {TR_PARAMETER_UNLOCK, "Desbloquear"},
    {TR_PARAMETER_TERRAIN_RUBBLE, "Escombros"},
    {TR_ACTION_TYPE_CHANGE_GOAL, "Alterar critérios de vitória"},
    {TR_PARAMETER_TYPE_WIN_CONDITION, "Condição de vitória"},
    {TR_SCENARIO_WIN_CONDITION_CULTURE, "Cultura"},
    {TR_SCENARIO_WIN_CONDITION_PROSPERITY, "Prosperidade"},
    {TR_SCENARIO_WIN_CONDITION_PEACE, "Paz"},
    {TR_SCENARIO_WIN_CONDITION_FAVOR, "Apreço"},
    {TR_SCENARIO_WIN_CONDITION_LOOSING_TIME, "Limite de tempo"},
    {TR_SCENARIO_WIN_CONDITION_WINNING_TIME, "Tempo de sobrevivência"},
    {TR_SCENARIO_WIN_CONDITION_POPULATION, "População"},
    {TR_EDITOR_COPY, "Copiar"},
    {TR_EDITOR_PASTE, "Colar"},
    {TR_EDITOR_SCENARIO_EVENTS_COPY_SELECTED, "Copiar seleção"},
    {TR_EDITOR_SCENARIO_EVENTS_PASTE_SELECTED, "Colar seleção"},
    {TR_EMPIRE_DELETE_OBJECT, "Excluir objeto"},
    {TR_EMPIRE_MOVE_OBJECT, "Mover objeto"},
    {TR_CONFIG_UI_EMPIRE_CLICK_TO_DELETE, "Exigir clique para excluir objetos"},
    {TR_EMPIRE_DRAW_TRADE_ROUTE, "Redesenhar rota"},
    {TR_CONFIG_UI_EMPIRE_CONFIRM_DELETE, "Confirmar exclusão de objetos"},
    {TR_EMPIRE_TOOL_LAND_ROUTE, "Rota comercial terrestre"},
    {TR_EMPIRE_TOOL_SEA_ROUTE, "Rota comercial marítima"},
    {TR_EMPIRE_TOGGLE_EDGES, "Alternar segmentos"},
    {TR_EMPIRE_EDGE_INDEX, "Nº do segmento"},
    {TR_EMPIRE_WAYPOINT_INDEX, "Nº do ponto de passagem"},
    {TR_EMPIRE_ROUTE_PARENT, "De"},
    {TR_EMPIRE_ORNAMENT_STONEHENGE, "Stonehenge"},
    {TR_EMPIRE_ORNAMENT_GALLIC_WHEAT, "Trigo gaulês"},
    {TR_EMPIRE_ORNAMENT_THE_PYRENEES, "Os Pireneus"},
    {TR_EMPIRE_ORNAMENT_IBERIAN_AQUEDUCT, "Aqueduto ibérico"},
    {TR_EMPIRE_ORNAMENT_TRIUMPHAL_ARCH, "Arco triunfal"},
    {TR_EMPIRE_ORNAMENT_WEST_DESERT_WHEAT, "Trigo do deserto ocidental"},
    {TR_EMPIRE_ORNAMENT_LIGHTHOUSE_ALEXANDRIA, "Farol de Alexandria"},
    {TR_EMPIRE_ORNAMENT_WEST_DESERT_PALMS, "Palmeiras do deserto ocidental"},
    {TR_EMPIRE_ORNAMENT_TRADE_SHIP, "Navio mercante"},
    {TR_EMPIRE_ORNAMENT_WATERSIDE_PALMS, "Palmeiras à beira d'água"},
    {TR_EMPIRE_ORNAMENT_THE_COLOSSEUM, "O Coliseu"},
    {TR_EMPIRE_ORNAMENT_THE_ALPS, "Os Alpes"},
    {TR_EMPIRE_ORNAMENT_ROMAN_TREE, "Árvore romana"},
    {TR_EMPIRE_ORNAMENT_GREEK_MOUNTAINS, "Cordilheira grega"},
    {TR_EMPIRE_ORNAMENT_THE_PARTHENON, "O Partenon"},
    {TR_EMPIRE_ORNAMENT_THE_PYRAMIDS, "As Pirâmides"},
    {TR_EMPIRE_ORNAMENT_HAGIA_SOPHIA, "Santa Sofia"},
    {TR_EMPIRE_ORNAMENT_EAST_DESERT_PALMS, "Palmeiras do deserto oriental"},
    {TR_EMPIRE_ORNAMENT_EAST_DESERT_WHEAT, "Trigo do deserto oriental"},
    {TR_EMPIRE_ORNAMENT_TRADE_CAMEL, "Camelo mercante"},
    {TR_EMPIRE_ORNAMENT_MOUNT_ETNA, "Monte Etna"},
    {TR_EMPIRE_ORNAMENT_COLOSSUS_RHODES, "Colosso de Rodes"},
    {TR_EMPIRE_ORNAMENT_THE_TEMPLE, "O Templo"},
    {TR_EMPIRE_BATTLE_PARENT, "Do caminho"},
    {TR_EDITOR_EMPIRE_PROPERTIES, "Propriedades do Império"},
    {TR_EDITOR_IMAGE_IMPORT, "Importar imagem"},
    {TR_EDITOR_UNABLE_TO_SET_EMPIRE_IMAGE, "Não foi possível definir a imagem do império"},

    {TR_EDITOR_IMAGE_TO_SMALL, "Imagem pequena demais"},
    {TR_EDITOR_IMAGE_TO_SMALL_EXPLANATION, "A imagem é tão pequena que pode causar erros no Editor do Império. Deseja carregá-la mesmo assim?"},
    {TR_EDITOR_EMPIRE_PROPERTIES_SELECT_IMAGE, "Selecionar imagem do império"},
    {TR_EDITOR_EMPIRE_PROPERTIES_DEFAULT_IMAGE, "Imagem padrão"},
    {TR_EDITOR_EMPIRE_PROPERTIES_SETTINGS, "Configurações do império"},
    {TR_EDITOR_EMPIRE_PROPERTIES_HOTKEYS, "Atalhos do império"},
    {TR_EDITOR_EMPIRE_PROPERTIES_BORDER_DENSITY, "Alterar densidade da fronteira"},
    {TR_EDITOR_EMPIRE_PROPERTIES_NEW_PATH, "Alterar caminho de invasão"},
    {TR_EDITOR_EMPIRE_PROPERTIES_ADD_ORNAMENT, "Adicionar ornamento"},
    {TR_EDITOR_EMPIRE_PROPERTIES_ALL_ORNAMENTS, "Adicionar todos os ornamentos"},
    {TR_EMPIRE_TOOLTIP_EDIT_NAME, "Editar nome da cidade"},
    {TR_EMPIRE_TOOLTIP_ADD_RESOURCE, "Adicionar recurso"},
    {TR_EDITOR_EMPIRE_PROPERTIES_ALL_CITIES, "Adicionar todas as cidades padrão"},
    {TR_EDITOR_EMPIRE_PROPERTIES_IRELAND, "Mostrar/ocultar Irlanda"},
    {TR_EMPIRE_TOOLTIP_ROUTE_TYPE, "Alternar tipo de rota"},
    {TR_EMPIRE_TOOLTIP_AFTER_ICON, "Alterar ícone da cidade após a conversão\nÍcone atual:"},
    {TR_EMPIRE_TOOL_PICK, "Selecionar ferramenta do império"},
    {TR_EMPIRE_TOOLTIP_SHOW_TOOLS, "Mostrar todas as ferramentas"},
    {TR_EMPIRE_TOOLTIP_ROUTE_COST, "Alterar custo da rota"},
    {TR_RESOURCE_SETTINGS_IN_GRANARIES, "em celeiros"},
    {TR_CONFIG_HEADER_RAIN, "Chuva"},
    {TR_CONFIG_HEADER_SNOW, "Neve"},
    {TR_CONFIG_HEADER_SAND, "Tempestades de areia"},
    {TR_CONFIG_HEADER_EMPIRE_EDITOR, "Editor do Império"},
    {TR_CONFIG_UI_WT_PREVIEW_RAIN, "Visualizar chuva"},
    {TR_CONFIG_UI_WT_PREVIEW_SNOW, "Visualizar neve"},
    {TR_CONFIG_UI_WT_PREVIEW_SANDSTORM, "Visualizar tempestade de areia"},
    {TR_CONFIG_UI_WT_PREVIEW_HEAVY_RAIN, "Visualizar chuva forte"},
    {TR_CONFIG_WT_RAIN_SPEED, "Velocidade das gotas"},
    {TR_CONFIG_WT_RAIN_LENGTH, "Tamanho das gotas"},
    {TR_CONFIG_WT_RAIN_INTENSITY, "Intensidade do efeito visual"},
    {TR_CONFIG_WT_SNOW_INTENSITY, "Intensidade do efeito visual"},
    {TR_CONFIG_WT_SANDSTORM_INTENSITY, "Intensidade do efeito visual"},
    {TR_CONFIG_WT_SANDSTORM_SPEED, "Velocidade da areia"},
    {TR_CONFIG_WT_SANDSTORM_SIZE, "Tamanho da areia"},
    {TR_CONFIG_WT_SNOW_SPEED, "Velocidade dos flocos de neve"},
    {TR_CONFIG_WT_SNOWFLAKE_SIZE, "Tamanho dos flocos de neve"},
    {TR_CONFIG_WT_SIZE_MINIMUM, "Mínimo"},
    {TR_CONFIG_WT_SIZE_SMALL, "Pequeno"},
    {TR_CONFIG_WT_SIZE_REGULAR, "Normal"},
    {TR_CONFIG_WT_SIZE_LARGE, "Grande"},
    {TR_CONFIG_WT_SIZE_MAXIMUM, "Máximo"},
    {TR_CONFIG_WT_SPEED_SLOW, "Lenta"},
    {TR_CONFIG_WT_SPEED_FAST, "Rápida"},
    {TR_CONFIG_WT_WEATHER_DURATION, "Duração do fenômeno"},
    {TR_CONFIG_WT_DURATION_SHORT, "Curta"},
    {TR_CONFIG_WT_DURATION_REGULAR, "Normal"},
    {TR_CONFIG_WT_DURATION_LONG, "Longa"},
    {TR_UI_TRADE_LEDGER_HEADER, "Registro Comercial"},
    {TR_ADVISOR_HEALTH_WATER_COVERAGE, "Água"},
    {TR_ADVISOR_HEALTH_HEALTH_COVERAGE, "Saúde"},
    {TR_BUILDING_FOUNTAINS, "Fontes"},
    {TR_BUILDING_WELLS, "Poços"},
    {TR_BUILDING_LATRINE, "Latrinas"},
    {TR_ADVISOR_CHIEF_WATER_COVERAGE, "Cobertura de água"},
    {TR_ADVISOR_CHIEF_CLEAN_WATER, "A maioria da população tem acesso à água limpa de fontes."},
    {TR_ADVISOR_CHIEF_LATRINE_AND_WELL, "A maioria da população tem acesso à água de poços e a uma latrina."},
    {TR_ADVISOR_CHIEF_WELL_WATER, "A maior parte da população precisa obter água de poços."},
    {TR_ADVISOR_CHIEF_NO_WATER, "A maior parte da população não tem acesso a um abastecimento de água adequado."},
    {TR_TOOLTIP_OVERLAY_PROBLEMS_DEPOT_NO_INSTRUCTIONS, "Sem instruções"},
    {TR_CONFIG_GRANARY_DEFAULT_TO_PASS_ALL_WALKERS, "Por padrão, celeiros não permitem a passagem de andarilhos"},
    {TR_CONFIG_WAREHOUSE_DEFAULT_TO_PASS_ALL_WALKERS, "Por padrão, armazéns não permitem a passagem de andarilhos"},
    {TR_CONDITION_TYPE_ENEMIES_IN_CITY, "Quantidade de inimigos na cidade"},
    {TR_CONDITION_TYPE_LAND_TRADE_PROBLEMS, "Duração dos problemas no comércio terrestre"},
    {TR_CONDITION_TYPE_SEA_TRADE_PROBLEMS, "Duração dos problemas no comércio marítimo"},
    {TR_BUILDING_FOURTH_FOODTYPE_MISSING_EVOLVE, "Esta moradia não pode evoluir porque precisa de um quarto tipo de comida, fornecido por um mercado local."},
    {TR_BUILDING_FOURTH_FOODTYPE_MISSING_DEVOLVE, "Esta moradia regredirá em breve porque, no momento, tem acesso a apenas três tipos de comida de seu mercado local."},
    {TR_BUILDING_FIFTH_FOODTYPE_MISSING_EVOLVE, "Esta moradia não pode evoluir porque precisa de um quinto tipo de comida, fornecido por um mercado local."},
    {TR_BUILDING_FIFTH_FOODTYPE_MISSING_DEVOLVE, "Esta moradia regredirá em breve porque, no momento, tem acesso a apenas quatro tipos de comida de seu mercado local."},
    {TR_ACTION_TYPE_MOVE_CAMERA, "Mover câmera"},
    {TR_ACTION_TYPE_CHANGE_WEATHER, "Alterar clima"},
    {TR_PARAMETER_INTENSITY, "Intensidade"},
    {TR_PARAMETER_TYPE_WEATHER, "Tipo de clima"},
    {TR_PARAMETER_CLEAN_WEATHER, "Tempo limpo"},
    {TR_CITY_PROPERTY_OPENED_ROUTES, "Rotas comerciais abertas"},
    {TR_PARAMETER_TYPE_ROUTE_TYPE, "Tipo de rota"},
    {TR_PARAMETER_ROUTE_TYPE_ALL, "Todas"},
    {TR_PARAMETER_ROUTE_TYPE_LAND, "Terrestre"},
    {TR_PARAMETER_ROUTE_TYPE_SEA, "Marítima"},
    {TR_EMPIRE_CITY_ICON_BUTTON, "Botão"},
    {TR_EDITOR_SCENARIO_CHANGE_MODEL_DATA, "Alterar dados do modelo"},
    {TR_EDITOR_PRICE_CHANGE, "mudança de preço"},
    {TR_EDITOR_PRICE_CHANGES, "mudanças de preço"},
    {TR_EDITOR_DEMAND_CHANGE, "mudança de demanda"},
    {TR_EDITOR_DEMAND_CHANGES, "mudanças de demanda"},
    {TR_BUILDING_FOURTH_GOOD_MISSING_EVOLVE, "Esta moradia não pode evoluir porque tem acesso aos templos de apenas três religiões. À medida que ascendem socialmente, seus moradores desejam dedicar mais tempo à veneração de outros deuses."},
    {TR_BUILDING_FOURTH_GOOD_MISSING_DEVOLVE, "Esta moradia regredirá em breve. Suas instalações religiosas, antes excelentes, foram reduzidas aos templos de apenas três deuses."},
    {TR_BUILDING_FIFTH_GOOD_MISSING_EVOLVE, "Esta moradia não pode evoluir porque tem acesso aos templos de apenas quatro religiões. À medida que ascendem socialmente, seus moradores desejam dedicar mais tempo à veneração de outros deuses."},
    {TR_BUILDING_FIFTH_GOOD_MISSING_DEVOLVE, "Esta moradia regredirá em breve. Suas instalações religiosas, antes excelentes, foram reduzidas aos templos de apenas quatro deuses."},
    {TR_EDITOR_SCENARIO_CHANGE_HOUSE_MODEL_DATA, "Alterar dados do modelo de moradia"},
    {TR_ACTION_TYPE_HIDE_TRADE_ROUTE, "Ocultar rota comercial"},
    {TR_PARAMETER_HIDE, "Ocultar"},
    {TR_EMPIRE_HIDE_TRADE_ROUTE, "Ocultar rota"},
    {TR_EMPIRE_SHOW_TRADE_ROUTE, "Mostrar rota"},
    {TR_EMPIRE_HIDE_EDGE, "Ocultar"},
    {TR_EMPIRE_SHOW_EDGE, "Mostrar"},
    {TR_ACTION_TYPE_CHANGE_VARIABLE_COLOR, "Alterar cor da variável personalizada"},
    {TR_CONDITION_TYPE_MONTHS_SINCE_FESTIVAL, "Meses desde o último festival"},
    {TR_EMPIRE_VULNERABLE_CITY, "Cidade vulnerável"},
    {TR_CONFIG_UI_EDITOR_SHOW_DELETION_WARNINGS, "Mostrar avisos ao excluir eventos, condições ou ações"},
    {TR_CATEGORY_UI_EDITOR, "Editor"},
    {TR_EDITOR_SCENARIO_EVENTS_DELETE_EVENTS_CONFIRM_TITLE, "Excluir eventos?"},
    {TR_EDITOR_SCENARIO_EVENTS_DELETE_EVENTS_CONFIRM_TEXT, "Tem certeza de que deseja excluir estes eventos?\n\nEsta ação é irreversível."},
    {TR_CONDITION_TYPE_DESIRABILITY_IN_AREA, "Atratividade na área"},
    {TR_CONDITION_TYPE_POPULATION_IN_AREA, "População na área"},
    {TR_PARAMETER_AGE_SCHOOL, "Idade escolar (0-14)"},
    {TR_PARAMETER_AGE_ACADEMY, "Faixa etária da academia (14-21)"},
    {TR_PARAMETER_AGE_WORKING, "Faixa etária de trabalho (20-49/59)"},
    {TR_PARAMETER_AGE_RETIRED, "Aposentados (50+/60+)"},
    {TR_WINDOW_ADVISOR_EPITHETS, "Poderes dos Deuses"},
    {TR_WINDOW_ADVISOR_EPITHETS_TOOLTIP, "Poderes divinos concedidos pelos Santuários"},
    {TR_WINDOW_ADVISOR_EPITHETS_TOOLTIP_CERES, "Poderes divinos de Ceres"},
    {TR_WINDOW_ADVISOR_EPITHETS_TOOLTIP_NEPTUNE, "Poderes divinos de Netuno"},
    {TR_WINDOW_ADVISOR_EPITHETS_TOOLTIP_MERCURY, "Poderes divinos de Mercúrio"},
    {TR_WINDOW_ADVISOR_EPITHETS_TOOLTIP_MARS, "Poderes divinos de Marte"},
    {TR_WINDOW_ADVISOR_EPITHETS_TOOLTIP_VENUS, "Poderes divinos de Vênus"},
    {TR_WINDOW_ADVISOR_EPITHETS_TOOLTIP_PANTHEON, "Poderes divinos do Panteão"},
    {TR_FIGURE_TYPE_PLEBIAN, "Plebeu"},
    {TR_CONFIG_GP_CH_HOUSING_DO_NOT_SPAWN_PLEBIANS, "Moradias não geram plebeus vagando sem destino"},
    {TR_EDITOR_MODEL_DATA_DEFAULT, "Padrão:"},
    {TR_ACTION_TYPE_IMMIGRATION_PERCENTAGE, "Ajustar porcentagem de migração"},
    {TR_PARAMETER_IMMIGRATION, "Ajustar imigração"},
    {TR_BUILDING_DEPOTS, "Guildas de carroceiros:"},
    {TR_DESTRIBUTION_SOURCE, "- usada como origem: "},
    {TR_DESTRIBUTION_DESTINATION, "- usada como destino: "},
    {TR_FIGURE_TYPE_DOG, "Cachorro"},
    {TR_CONFIG_GP_CH_HOUSING_DO_NOT_SPAWN_DOGS, "Moradias não geram cachorros vagando"},
    {TR_CONFIG_HEADER_DESIRABILITY, "Atratividade"},
    {TR_CONFIG_SHOW_SHORELINE_DESIRABILITY, "Mostrar a atratividade do litoral na visão"},
    {TR_CONFIG_SHOW_ELEVATION_DESIRABILITY, "Mostrar a atratividade da elevação na visão"},
    {TR_BUILDING_TRIUMPHAL_ARCH_PHASE_1, "(Suportes)"},
    {TR_BUILDING_TRIUMPHAL_ARCH_PHASE_2, "(Fachada)"},
    {TR_BUILDING_TRIUMPHAL_ARCH_PHASE_1_TEXT, "Os pedreiros assentam a alvenaria e erguem pilares imponentes para um arco colossal que eternizará o valor de seus exércitos e proclamará seus feitos triunfais às gerações futuras."},
    {TR_BUILDING_TRIUMPHAL_ARCH_PHASE_2_TEXT, "Artesãos habilidosos concluem a fachada do grande arco com relevos finamente esculpidos, pedras polidas e estátuas que honram a coragem de seus soldados, conferindo ao monumento a dignidade de um triunfo romano."},
    {TR_BUILDING_TRIUMPHAL_ARCH_CONSTRUCTION_DESC, "O arco triunfal não precisa de recursos da cidade para ser construído. Todos os recursos e trabalhadores necessários serão fornecidos por Roma."},
    {TR_CITY_MESSAGE_TITLE_TRIUMPHAL_ARCH_COMPLETE, "Arco triunfal concluído"},
    {TR_CITY_MESSAGE_TEXT_TRIUMPHAL_ARCH_COMPLETE, "O arco triunfal está concluído. Sua imponente estrutura de pedra e sua fachada finamente esculpida honram a coragem de nossos soldados e as vitórias que conquistaram para a cidade. Que permaneça por gerações como símbolo de força, sacrifício e orgulho cívico."},
    {TR_BUILDING_TRIUMPHAL_ARCH_SUPPLIED_BY_ROME, "(Fornecido por Roma)"},
    {TR_WARNING_ENEMIES_PREVENT_BRIDGE_DESTRUCTION, "Não é possível destruir pontes durante uma invasão!"},
    {TR_CONFIG_GP_CH_ENEMIES_RETREAT_FAST, "Inimigos recuam duas vezes mais rápido"},
    {TR_CONFIG_CATEGORY_MANAGEMENT_MILITARY, "Militar"},
    {TR_CHEAT_CHANGED_MONUMENT_RESOURCES, "Os recursos necessários para o tipo de monumento foram alterados"},
    {TR_ACTION_TYPE_CHANGE_MONUMENT_RESOURCES, "Alterar recursos necessários para o monumento"},
    {TR_PARAMETER_TYPE_MONUMENT, "Tipo de monumento"},
    {TR_PARAMETER_MONUMENT_STAGE, "Fase"},
    {TR_RESOURCE_ARCHITECTS, "Arquitetos"},
    {TR_ACTION_TYPE_RENAME_CITY, "Alterar nome da cidade"},
    {TR_PARAMETER_TYPE_CITY, "Cidade"},
    {TR_PARAMETER_NAME, "Nome"},
    {TR_CONFIG_UI_AUTO_DELETE_OLD_COMMON_MESSAGES, "Excluir automaticamente mensagens comuns após cinco anos"},
    {TR_UI_CURRENT_YEAR, "Ano atual"},
    {TR_UI_HIDE_IRRELEVANT_RESOURCES, "Ocultar recursos irrelevantes"},
    {TR_UI_YEAR_AGO, " ano atrás"},
    {TR_UI_YEARS_AGO, " anos atrás "},
    {TR_UI_LAST_YEAR, "Ano passado "},
    {TR_UI_SELECT_TRADE_LEDGER_YEAR, "Selecionar ano"},
    {TR_UI_TRADE_LEDGER_OPEN, "Abertas"},
    {TR_UI_TRADE_LEDGER_CLOSED, "Fechadas"},
    {TR_UI_TRADE_LEDGER_BOTH, "Abertas/fechadas"},
    {TR_UI_TRADE_LEDGER_TRADES, "Transações"},
    {TR_UI_TRADE_LEDGER_BUYS, "Compras"},
    {TR_UI_TRADE_LEDGER_SELLS, "Vendas"},
    {TR_UI_TOOLTIP_CLEAR_SELECTION, "Limpar seleção"},
    {TR_UI_TOOLTIP_SELECT_RESOURCE_FILTER, "Selecionar recurso"},
    {TR_UI_TOOLTIP_RESET_SORTING, "Redefinir ordenação"},
    {TR_UI_TOOLTIP_SELECT_SORTING, "Selecionar ordenação"},
    {TR_UI_TOOLTIP_RESET_FILTERS, "Redefinir filtros"},
    {TR_UI_TOOLTIP_SHOW_ALL_ROUTE_TYPES, "Mostrar todos os tipos de rota"},
    {TR_UI_TOOLTIP_SHOW_LAND_ROUTES, "Mostrar rotas terrestres"},
    {TR_UI_TOOLTIP_SHOW_SEA_ROUTES, "Mostrar rotas marítimas"},

    {TR_UI_TOOLTIP_SHOW_OPEN_AND_CLOSED_ROUTES, "Mostrar rotas abertas e fechadas"},
    {TR_UI_TOOLTIP_SHOW_OPEN_ROUTES, "Mostrar rotas abertas"},
    {TR_UI_TOOLTIP_SHOW_CLOSED_ROUTES, "Mostrar rotas fechadas"},
    {TR_UI_TOOLTIP_SELECT_CITY_RESOURCE_TRADE, "Selecionar filtro de recursos da cidade"},
    {TR_UI_TOOLTIP_OPEN_TRADE_LEDGER, "Abrir Registro Comercial"},
    {TR_UI_SIDEBAR_TRADE_HISTORY, "Histórico Comercial"},
    {TR_UI_SIDEBAR_TRADE_HISTORY_TOOLTIP, "Ver os registros comerciais do ano selecionado"},
    {TR_UI_SIDEBAR_TRADE_HISTORY_TOOLTIP_LOST, "Seus escribas não guardam registros por tanto tempo!"},
    {TR_UI_LEDGER_BTN_IMPORTED, "Imp"},
    {TR_UI_LEDGER_TT_IMPORTED, "Ordenar por importações"},
    {TR_UI_LEDGER_BTN_PRODUCED, "Pro"},
    {TR_UI_LEDGER_TT_PRODUCED, "Ordenar por produção"},
    {TR_UI_LEDGER_BTN_CONSUMED, "Con"},
    {TR_UI_LEDGER_TT_CONSUMED, "Ordenar por consumo"},
    ...
    {TR_CONFIG_UI_SCROLL_CAMERA_UNLOCKED, "Expandir limites da câmera"},
    {TR_UI_LEDGER_ONLY_CURRENT_YEAR, "Seu mandato como Governador começou neste ano!"},
    {TR_EMPIRE_TOOLTIP_ROUTE_COST_HELP, "Clique com o botão direito: opções avançadas de custo"},
    {TR_EMPIRE_ROUTE_COST, "Custo da rota:"},
    {TR_EMPIRE_RESOURCE_COST, "Recursos necessários para abrir"},
    {TR_EMPIRE_COSTS, "Custos"},
    {TR_EMPIRE_NO_RESOURCES_TITLE, "Recursos insuficientes"},
    {TR_EMPIRE_NO_RESOURCES_TEXT, "Não há recursos suficientes para abrir a rota.\n Certifique-se de que suas indústrias tenham funcionários suficientes e considere construir mais para obter os recursos necessários."},
    {TR_ACTION_TYPE_CHANGE_ROUTE_RESOURCE_COST, "Alterar custo de abertura da rota comercial (recursos)"},
    {TR_ACTION_TYPE_KILL_WALKERS_IN_AREA, "Eliminar andarilhos na área"},
    {TR_PARAMETER_TYPE_FIGURE_CATEGORY, "Categoria de entidade"},
    {TR_PARAMETER_FIGURE_CATEGORY_INACTIVE, "Inativos"},
    {TR_PARAMETER_FIGURE_CATEGORY_CITIZEN, "Cidadãos"},
    {TR_PARAMETER_FIGURE_CATEGORY_ARMED, "Armados"},
    {TR_PARAMETER_FIGURE_CATEGORY_HOSTILE, "Hostis"},
    {TR_PARAMETER_FIGURE_CATEGORY_CRIMINAL, "Criminosos"},
    {TR_PARAMETER_FIGURE_CATEGORY_NATIVE, "Nativos"},
    {TR_PARAMETER_FIGURE_CATEGORY_ANIMAL, "Animais"},
    {TR_PARAMETER_FIGURE_CATEGORY_AGGRESSIVE_ANIMAL, "Animais agressivos"},
    {TR_PARAMETER_FIGURE_CATEGORY_PROJECTILE, "Projéteis"},
    {TR_PARAMETER_FIGURE_CATEGORY_EFFECT, "Efeitos"},
    {TR_PARAMETER_FIGURE_CATEGORY_INDUSTRY, "Indústria"},
    {TR_PARAMETER_FIGURE_CATEGORY_ENTERTAINMENT, "Entretenimento"},
    {TR_PARAMETER_FIGURE_CATEGORY_EDUCATION, "Educação"},
    {TR_PARAMETER_FIGURE_CATEGORY_HEALTH, "Saúde"},
    {TR_PARAMETER_FIGURE_CATEGORY_MULTIPLE, "Múltiplas"},
    {TR_PARAMETER_FIGURE_CATEGORY_NONE, "Nenhuma"},
    {TR_PARAMETER_TOOLTIP_FIGURE_CATEGORY_INACTIVE, "Entidades sem vida\n Por exemplo: nuvens de poeira, navios mercantes e projéteis"},
    {TR_PARAMETER_TOOLTIP_FIGURE_CATEGORY_CITIZEN, "Todos os romanos aliados, incluindo animais de estimação"},
    {TR_PARAMETER_TOOLTIP_FIGURE_CATEGORY_ARMED, "Todas as pessoas e animais dispostos a defender a cidade com a própria vida"},
    {TR_PARAMETER_TOOLTIP_FIGURE_CATEGORY_HOSTILE, "Todos os que se opõem à cidade"},
    {TR_PARAMETER_TOOLTIP_FIGURE_CATEGORY_CRIMINAL, "Criminosos e revoltosos"},
    {TR_PARAMETER_TOOLTIP_FIGURE_CATEGORY_NATIVE, "Nativos, inclusive os pacíficos"},
    {TR_PARAMETER_TOOLTIP_FIGURE_CATEGORY_ANIMAL, "Animais de rebanho"},
    {TR_PARAMETER_TOOLTIP_FIGURE_CATEGORY_AGGRESSIVE_ANIMAL, "Lobos"},
    {TR_PARAMETER_TOOLTIP_FIGURE_CATEGORY_PROJECTILE, "Projéteis\n Por exemplo: dardos, flechas etc."},
    {TR_PARAMETER_TOOLTIP_FIGURE_CATEGORY_EFFECT, "Entidades decorativas\n Por exemplo: nuvens de poeira, gaivotas ou cavalos correndo no hipódromo"},
    {TR_PARAMETER_TOOLTIP_FIGURE_CATEGORY_INDUSTRY, "Andarilhos industriais\n Muitas pessoas pertencem a esta categoria."},
    {TR_PARAMETER_TOOLTIP_FIGURE_CATEGORY_ENTERTAINMENT, "Andarilhos de entretenimento"},
    {TR_PARAMETER_TOOLTIP_FIGURE_CATEGORY_EDUCATION, "Andarilhos de educação"},
    {TR_PARAMETER_TOOLTIP_FIGURE_CATEGORY_HEALTH, "Andarilhos de saúde"},
    {TR_CONDITION_TYPE_FIGURES_IN_AREA, "Quantidade de entidades na área"},
    {TR_ACTION_TYPE_SEND_CITY_WARNING, "Enviar aviso da cidade"},
    {TR_PARAMETER_MESSAGE, "Mensagem"},
