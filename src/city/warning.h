...
typedef enum {
    ...
    WARNING_REPAIR_IMPOSSIBLE = 94,
    WARNING_REPAIR_BURNING = 95,
    WARNING_REPAIR_MONUMENT = 96,
    WARNING_REPAIR_AQUEDUCT = 97,
    WARNING_DEPOT_CART_PUSHER_RECALL_ALL = 98,
    WARNING_DEPOT_RESOURCE_CHANGE = 99,
    WARNING_WORKCAMP_NEEDED = 100,
    WARNING_BUILD_WORKCAMP = 101,
    WARNING_OPEN_WATER_NEEDED_FOR_BUILDING = 102,
    WARNING_ENEMIES_PREVENT_BRIDGE_DESTRUCTION = 103
} warning_type;
