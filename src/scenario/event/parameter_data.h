...
typedef enum {
    ...
    PARAMETER_TYPE_HOUSING_TYPE_WITH_GROUPS,
    ...
    PARAMETER_TYPE_MONUMENT,
    PARAMETER_TYPE_RESOURCE_MONUMENT,
    PARAMETER_TYPE_CITY,
    PARAMETER_TYPE_CUSTOM_TEXT,
    PARAMETER_TYPE_FIGURE_CATEGORY
} parameter_type;
