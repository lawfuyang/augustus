...
enum {
    ...
    FIGURE_ACTION_251_WORK_CAMP_WORKER_GETTING_FOR_HIGHWAY_STATION = 251,
    FIGURE_ACTION_252_WORK_CAMP_WORKER_GOING_TO_HIGHWAY_STATION = 252,
    FIGURE_ACTION_253_WORK_CAMP_SLAVE_GOING_TO_HIGHWAY_STATION = 253,
};
