...
typedef enum {
    ...
    FIGURE_PLEBIAN = 97,
    FIGURE_DOG = 98,
    FIGURE_HIGHWAY_STATION_SUPPLIER = 99,
    FIGURE_TYPE_MAX = 100
} figure_type;

typedef enum {
    FIGURE_SOUND_NONE = 0,
    FIGURE_SOUND_PREFECT = 1,
    FIGURE_SOUND_TROOP = 2,
    FIGURE_SOUND_ENGINEER = 3,
    FIGURE_SOUND_TAX_COLLECTOR = 4,
    FIGURE_SOUND_MARKET_LADY = 5,
    FIGURE_SOUND_CARTPUSHER = 6,
    FIGURE_SOUND_DONKEY = 7,
    FIGURE_SOUND_BOATS = 8,
    FIGURE_SOUND_PRIEST = 9,
    FIGURE_SOUND_TEACHER = 10,
    FIGURE_SOUND_PUPILS = 11,
    FIGURE_SOUND_BATHOUSE_LADY = 12,
    FIGURE_SOUND_DOCTOR = 13,
    FIGURE_SOUND_BARBER = 14,
    FIGURE_SOUND_ACTOR = 15,
    FIGURE_SOUND_GLADIATOR = 16,
    FIGURE_SOUND_LION_TAMER = 17,
    FIGURE_SOUND_CHARIOTEER = 18,
    FIGURE_SOUND_PATRICIAN = 19,
    FIGURE_SOUND_PLEBIAN = 20,
    FIGURE_SOUND_RIOTER = 21,
    FIGURE_SOUND_HOMELESS = 22,
    FIGURE_SOUND_UNEMPLOYED = 23,
    FIGURE_SOUND_EMIGRANT = 24,
    FIGURE_SOUND_IMMIGRANT = 25,
    FIGURE_SOUND_ENEMY = 26,
    FIGURE_SOUND_MISSIONARY = 31,
    FIGURE_SOUND_GRANARY_BOY = 32,
    FIGURE_SOUND_OX_CART_PUSHER = 33,
    FIGURE_SOUND_DOG = 34,
    FIGURE_SOUND_MAX = 35
} figure_sound_types;
