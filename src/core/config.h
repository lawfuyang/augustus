...
typedef enum {
    ...
    CONFIG_UI_EDITOR_SHOW_DELETION_WARNINGS,
    ...
    CONFIG_GP_CH_ENEMIES_RETREAT_FAST,
    CONFIG_UI_EMPIRE_SIDEBAR_SORT_METHOD,
    CONFIG_UI_EMPIRE_SIDEBAR_SORT_REVERSED,
    CONFIG_UI_EMPIRE_SIDEBAR_FILTER_ROUTE_TYPE,
    CONFIG_UI_EMPIRE_SIDEBAR_FILTER_ROUTE_OPEN,
    CONFIG_UI_EMPIRE_SIDEBAR_FILTER_RESOURCE_TYPE,
    CONFIG_UI_EMPIRE_SIDEBAR_FILTER_RESOURCE,
    CONFIG_UI_AUTO_CYCLE_TEMPLES,
    CONFIG_UI_AUTO_CYCLE_GARDENS,
    CONFIG_UI_AUTO_DELETE_OLD_COMMON_MESSAGES,
    CONFIG_UI_SCROLL_CAMERA_UNLOCKED,
    CONFIG_UI_SCROLL_LEGACY_SCROLLBAR,
    CONFIG_MAX_ENTRIES
} config_key;
